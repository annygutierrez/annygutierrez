...
const spotlightSection = () => (
  <div className={classes.SpotlightContainer}>
    ...
    <p className={classes.SpotlightContent}>
      This is <a className={classes.textLink} rel="noopener noreferrer" target="_blank" href="https://medium.com/laboratoria/diversidad-x-desigualdad-salarial-entre-hombres-y-mujeres-881b32800ce">the Hackathon of gender equility</a>, 720 minutes to find a creative solution for three big problems, teams of programmers in four Latin American countries working together.
  </p>
